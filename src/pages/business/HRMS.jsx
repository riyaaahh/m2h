...
const HRMS = () => {
    ...
    const products = [
        {
            name: "officekit HR",
            description: "A complete HR automation suite for modern enterprises.",
            link: "/products/officekit-hr"
        },
        {
            name: "HR Desk",
            description: "Intuitive helpdesk system for employee query management.",
            link: "/products/hr-desk"
        },
        {
            name: "Alfapay",
            description: "Next-gen payroll solution with multi-country compliance.",
            link: "/products/alfapay"
        }
    ]
            ...
            <section className="relative pt-48 pb-32 px-10 max-w-[1440px] mx-auto overflow-hidden">
                ...
                >
                    ...
                    <h1 className="text-[4rem] md:text-[6rem] font-medium tracking-tighter leading-[0.95] lowercase mb-12 max-w-[1000px]">
                        Smart <span className="text-[#f4aa38]">HRMS</span> Solutions
                    </h1>
                    <p className="text-xl md:text-2xl font-light text-black/60 max-w-[800px] leading-relaxed lowercase mb-16 mx-auto">
                        Empowering organizations with intelligent human resource management tools that streamline operations and enhance employee experiences.
                    </p>
                    <Link to="/contact">
                        <motion.button
                    ...
                    >
                        <div>
                            <p className="text-2xl font-light leading-relaxed text-black/80 lowercase">
                                our human resource management systems are engineered to solve the complexities of modern workforce administration. from startups to large-scale enterprises, we provide the digital foundation needed to manage your most valuable asset: people.
                            </p>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-[0.9rem] text-black/50 uppercase tracking-widest font-medium">
                            <div className="space-y-4">
                                <p className="text-[#f4aa38]">Industries Served</p>
                            ...
                            <div className="space-y-4">
                                <p className="text-[#f4aa38]">Key Impact</p>
                                <ul className="space-y-2">
                ...
                <div className="flex flex-col md:flex-row gap-20 items-start">
                    <div className="md:w-1/3 sticky top-32">
                        ...
                        <p className="text-black/50 lowercase text-lg">
                            we bridge the gap between fragmented administrative tasks and a unified, efficient workplace ecosystem.
                        </p>
                    </div>
