...
const AI = () => {
    ...
    const products = [
        {
            name: "NeuroCore AI",
            description: "Advanced neural network engine for predictive enterprise modeling.",
            link: "/products/neurocore-ai"
        },
        {
            name: "VisionLink",
            description: "High-precision computer vision system for industrial automation.",
            link: "/products/visionlink"
        },
        {
            name: "DataFlow ML",
            description: "Seamless machine learning pipeline for real-time data processing.",
            link: "/products/dataflow-ml"
        }
    ]
            ...
            <section className="relative pt-48 pb-32 px-10 max-w-[1440px] mx-auto overflow-hidden">
                ...
                >
                    ...
                    <h1 className="text-[4rem] md:text-[6rem] font-medium tracking-tighter leading-[0.95] lowercase mb-12 max-w-[1000px]">
                        Artificial <span className="text-[#f4aa38]">Intelligence</span> Solutions
                    </h1>
                    <p className="text-xl md:text-2xl font-light text-black/60 max-w-[800px] leading-relaxed lowercase mb-16 mx-auto">
                        Revolutionizing business processes through intelligent automation, predictive insights, and neural architectures.
                    </p>
                    <Link to="/contact">
                        <motion.button
                    ...
                    >
                        <div>
                            <p className="text-2xl font-light leading-relaxed text-black/80 lowercase">
                                our AI solutions are designed to bridge the gap between complex data and actionable intelligence. we build systems that don't just process information, but learn and evolve to meet the unique challenges of your industry.
                            </p>
                        </div>
                ...
                <div className="flex flex-col md:flex-row gap-20 items-start">
                    <div className="md:w-1/3 sticky top-32">
                        ...
                        <p className="text-black/50 lowercase text-lg">
                            overcoming the barriers to entry for advanced intelligence in traditional workflows.
                        </p>
                    </div>
