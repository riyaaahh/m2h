...
const Business = () => {
    ...
    return (
        <div className="min-h-screen bg-white font-['Outfit'] selection:bg-[#f4aa38]/10 relative">
            ...
            <div className="relative z-10 max-w-[1440px] mx-auto px-10 pt-48 pb-32">
                ...
                >
                    ...
                    <h1 className="text-[4rem] md:text-[8rem] font-medium tracking-tighter leading-[0.9] lowercase text-black">
                        strategic industry <span className="text-black/10">solutions</span> for the <span className="text-[#f4aa38]">modern</span> era
                    </h1>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-black/5 border border-black/5 overflow-hidden rounded-[2rem] shadow-xl">
                    {sectors.map((sector, index) => (
                        <motion.div
                            ...
                            className="bg-white p-16 flex flex-col group hover:bg-slate-50 transition-colors"
                        >
                            ...
                            <p className="text-xl font-light text-black/30 mb-10 leading-relaxed lowercase">
                                {sector.description}
                            </p>

                            <div className="flex flex-wrap gap-2 mt-auto">
                                {sector.features.map((feature) => (
                                    <span key={feature} className="px-5 py-2 rounded-full border border-black/5 text-[0.65rem] font-medium tracking-tight lowercase text-black/20 group-hover:text-black/40 group-hover:border-[#f4aa38]/20 transition-all duration-500">
                                        {feature}
                                    </span>
                                ))}
                            </div>
                ...
                >
                    <Link
                        to="/contact"
                        className="text-[1.2rem] md:text-[2rem] font-medium tracking-tight lowercase text-black hover:text-[#f4aa38] transition-colors flex items-center gap-4 group"
                    >
