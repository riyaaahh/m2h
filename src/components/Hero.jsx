...
const Hero = () => {
    ...
    return (
        <section ref={heroRef} className="relative h-screen flex flex-col gap-20 justify-center px-10 md:px-20 z-20">
            <div className="flex justify-between items-start w-full mb-2 max-w-[1340px] mx-auto  ">
                ...
                <motion.div
                    ...
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ duration: 0.8 }}
                    className="flex items-center gap-2 text-[0.8rem] font-medium tracking-tight text-black/40"
                >
            ...
            >
                <motion.h1
                    ...
                    className="text-[4rem] sm:text-[6rem] md:text-[9rem] lg:text-[7rem] font-medium leading-[0.9] tracking-[-0.04em] lowercase text-black"
                >
                    a software agency
                    <br />
                    <span className="text-[#f4aa38]">redefining</span> <span className="text-black">digital</span>
                    <br />
                    experiences with <span className="text-[#f4aa38]">precision</span>
                </motion.h1>
            </motion.div>
            ...
            >
                <div className="flex flex-col gap-2">
                    ...
                    <span className="text-[0.6rem] uppercase tracking-[0.4em] text-black/20 -rotate-90 origin-left mt-24">scroll to explore</span>
                </div>
            </motion.div>
        </section>
    )
